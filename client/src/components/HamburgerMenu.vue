<template>
  ...
  >
    ...
    >
      ...
      >
        <span class="material-icons-outlined mobile:text-sm">dashboard</span
        >Admin dashboard
      </button>
      <button
        v-if="accessLevel === 'admin'"
        ...
        "
      >
        <span class="material-icons-outlined mobile:text-sm">person_add</span>
        Register user
      </button>
      <button
        class="h-[42px] mobile:h-[38px] w-[200px] mobile:w-[180px] bg-[rgba(55,55,55,0.66)] rounded-lg border border-[#a1a1a1] text-left justify-center items-center vertical-middle flex m-[2px] flex-row font-inter text-white hover:bg-[rgba(80,80,80,0.7)] transition-all duration-200 hover:scale-105 hover:shadow-lg burber-item text-sm mobile:text-xs"
        ...
        "
      >
        <span class="material-icons-outlined mobile:text-sm">folder</span> My
        files
      </button>
      <button
        class="h-[42px] mobile:h-[38px] w-[200px] mobile:w-[180px] bg-[rgba(55,55,55,0.66)] rounded-lg border border-[#a1a1a1] text-left justify-center items-center vertical-middle flex m-[2px] flex-row font-inter text-white hover:bg-[rgba(80,80,80,0.7)] transition-all duration-200 hover:scale-105 hover:shadow-lg burber-item text-sm mobile:text-xs"
        ...
        "
      >
        <span class="material-icons-outlined mobile:text-sm">link</span> My
        links
      </button>
      <button
        class="h-[42px] mobile:h-[38px] w-[200px] mobile:w-[180px] bg-[rgba(55,55,55,0.66)] rounded-lg border border-[#a1a1a1] text-left justify-center items-center vertical-middle flex m-[2px] flex-row font-inter text-white hover:bg-[rgba(80,80,80,0.7)] transition-all duration-200 hover:scale-105 hover:shadow-lg burber-item text-sm mobile:text-xs"
        ...
        "
      >
        <span class="material-icons-outlined mobile:text-sm">password</span>
        Change password
      </button>
