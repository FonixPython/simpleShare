    ...
    >
      ...
      >
        <div class="w-full">
          <div class="flex justify-between items-center mb-2">
            <span class="text-sm mobile:text-xs text-gray-300"
              >Upload Progress</span
            >
            <span class="text-sm mobile:text-xs font-medium text-primary-button"
              >{{ uploadProgress.percentage }}%</span
            >
          </div>
          <div
            class="w-full bg-gray-700 rounded-full h-3 mobile:h-2 overflow-hidden"
          >
            <div
      ...
      >
        ...
        <div class="text-center mb-6">
          <div
            class="inline-flex items-center justify-center w-16 h-16 mobile:w-12 mobile:h-12 rounded-full bg-red-500/20 mb-4"
          >
            <span
              class="material-icons-outlined text-3xl mobile:text-2xl"
              style="color: #f77b5e"
              >error</span
            >
          </div>
          <h2
            class="text-2xl mobile:text-xl font-inter font-semibold text-white mb-2"
          >
            Upload failed!
          </h2>
        </div>
        ...
        <div class="w-full space-y-4">
          <!-- Error Message Box -->
          <div
            class="bg-black/30 border border-red-500/30 rounded-xl p-4 mobile:p-3"
          >
            <div class="flex items-start gap-3">
              <span
                class="material-icons-outlined text-red-400 text-lg mobile:text-sm mt-0.5"
                >info</span
              >
              <div class="flex-1">
                <p
                  class="text-sm mobile:text-xs text-gray-300 font-medium mb-1"
                >
                  Error Details
                </p>
                <p class="text-sm mobile:text-xs text-red-400 font-inter">
                  {{ uploadError }}
                </p>
              </div>
            </div>
          ...
          <div
            v-if="errorType"
            class="bg-black/20 border border-gray-600/30 rounded-xl p-4 mobile:p-3"
          >
            <div class="flex items-start gap-3">
              <span
                class="material-icons-outlined text-blue-400 text-lg mobile:text-sm mt-0.5"
                >lightbulb</span
              >
              <div class="flex-1">
                <p
                  class="text-sm mobile:text-xs text-gray-300 font-medium mb-2"
                >
                  What you can try:
                </p>
                <ul
                  class="text-xs mobile:text-[11px] text-gray-400 space-y-1.5"
                >
                  <li
                  ...
                  >
                    ...
                    <span
                      >Delete old files to free up space or upload a smaller
                      file</span
                    >
                  </li>
                  <li
                    v-if="errorType === 'auth_error'"
                    class="flex items-start gap-2"
                  >
                    <span class="text-blue-400 mt-0.5">•</span>
                  ...
                  <li
                    v-if="errorType === 'invalid_request'"
                    class="flex items-start gap-2"
                  >
                    <span class="text-blue-400 mt-0.5">•</span>
                    <span
                      >Check if the file format is supported and not
                      corrupted</span
                    >
                  </li>
                  <li
                  ...
                  >
                    <span class="text-blue-400 mt-0.5">•</span>
                    <span
                      >Check your internet connection and try uploading
                      again</span
                    >
                  </li>
                  <li
                    v-if="errorType === 'rate_limit'"
                    class="flex items-start gap-2"
                  >
                    <span class="text-blue-400 mt-0.5">•</span>
                  ...
                  >
                    <span class="text-blue-400 mt-0.5">•</span>
                    <span
                      >Try again in a few minutes or contact support if it
                      persists</span
                    >
                  </li>
          ...
          <div class="flex gap-3 mobile:gap-2 justify-center pt-2">
            ...
            >
              <span class="material-icons-outlined text-lg mobile:text-sm"
                >refresh</span
              >
              Retry Upload
            </button>
      ...
      >
        ...
        >
          ...
          <p
            class="text-sm mobile:text-xs text-gray-400 mb-3 font-inter mt-6 mobile:mt-4"
          >
        ...
        >
          ...
          <div class="text-left max-h-40 overflow-y-auto mb-4 space-y-2">
            ...
            >
              ...
              >
              <span class="text-primary-button font-red-hat ml-2">{{
                file.code
              }}</span>
            </div>
          </div>
            ...
            (progress) => {
              ...
              if (progress.percentage > 0) {
                ...
                const speedBytesPerSecond =
                  progress.loaded / (timeElapsed / 1000);
