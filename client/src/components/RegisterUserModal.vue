    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            class="bg-black/20 p-3 mobile:p-2 rounded-xl border border-[#444]"
          >
            <label class="block text-white mb-2">
              <span class="text-sm mobile:text-xs font-inter"
                >Storage Quota:</span
              >
            </label>
            <select
        ...
        >
          <span
            v-if="loading"
            class="material-icons-outlined animate-spin-slow mr-2"
